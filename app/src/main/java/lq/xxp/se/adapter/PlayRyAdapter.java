...
import lq.xxp.se.R;
import lq.xxp.se.activity.PlayActivity;


public class PlayRyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<PlayBean> mDatas;
    private Context mContext;
    private LayoutInflater inflater;

    public PlayRyAdapter(Context context, List<PlayBean> datas) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        holder.tv_num.setText(mDatas.get(position).getType());
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("mmds","连接"+mDatas.get(position).getLink());
                bundle.putString("Link", mDatas.get(position).getLink());
